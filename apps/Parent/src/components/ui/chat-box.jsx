    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm">
            <div className="w-full max-w-md mx-4 bg-white rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
                {/* Header */}
                <div className="bg-gradient-to-r from-[#171E57] to-[#2A3375] px-6 py-4 flex items-center justify-between">
                        ...
                        {predefinedQuestions.map((question, index) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    "border border-slate-200 hover:border-[#171E57]",
                                    "bg-white hover:bg-[#171E57]/5",
                                    "text-sm text-slate-700 hover:text-[#171E57]",
                                    "shadow-sm hover:shadow-md",
                                    "transform hover:-translate-y-0.5",
                                    selectedQuestion === question && "bg-[#171E57]/5 border-[#171E57] text-[#171E57]"
                                )}
                            >
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            className={cn(
                                ...
                                "border border-slate-300 focus:border-[#171E57]",
                                "focus:outline-none focus:ring-2 focus:ring-[#171E57]/20",
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                "bg-gradient-to-r from-[#171E57] to-[#2A3375]",
                                "hover:from-[#171E57]/90 hover:to-[#2A3375]/90",
