    ...
    >
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="mt-3">
            <span className="inline-block text-sm bg-[#E7F3FF] dark:bg-blue-900/30 text-[#1678FF] dark:text-blue-300 px-3 py-1 rounded-full font-medium font-poppins">This Year</span>
          </div>
        </div>

        <div className="text-[56px] font-normal text-slate-900 dark:text-white leading-none font-poppins" style={{ fontFamily: "'Poppins', sans-serif" }}>
