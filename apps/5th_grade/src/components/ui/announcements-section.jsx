...
export const AnnouncementsSection = () => {
  return (
    <div className="w-full max-w-[320px] md:max-w-[340px] lg:max-w-[320px] h-auto flex flex-col pb-4 md:pb-6 overflow-visible">
      {/* Header */}
      <div className="mb-6">
      ...
      <div className="flex flex-col gap-4">
        {announcements.map((announcement) => (
          <div
            key={announcement.id}
            className="relative bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow transition-shadow overflow-hidden"
          >
            {/* Accent Bar */}
