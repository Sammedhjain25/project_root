        ...
        >
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 sm:p-4 md:p-6 relative scrollbar-hide flex flex-col @[media(min-width:1024px)_and_(max-width:1366px)]:p-4">
            <div className="flex-1 flex flex-col">
              {/* Page Title */}
              <h1 className={`text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 ml-0 sm:ml-3 ${darkMode ? 'text-white' : 'text-gray-900'}`} style={{ fontFamily: 'Poppins, sans-serif' }}>
                Announcements
              </h1>
              ...
              <div className="flex flex-col gap-3 sm:gap-4 flex-1">
                {announcements.map((announcement) => (
                  <div
                    key={announcement.id}
                    className={`rounded-lg shadow-sm p-4 sm:p-6 relative ${darkMode ? 'bg-[#111c44]' : 'bg-white'}`}
                  ...
                  >
                    ...
                    <div className="pr-16 sm:pr-24">
                      {/* Title */}
                      <h2 className={`text-base sm:text-lg font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
                        {announcement.title}
                      </h2>

                      {/* Issue Date */}
                      <p className={`text-xs sm:text-sm mb-2 sm:mb-3 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
