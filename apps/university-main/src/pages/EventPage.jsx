        ...
        >
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 sm:p-4 md:p-6 lg:p-4 xl:p-6 relative scrollbar-hide @[media(min-width:1024px)_and_(max-width:1366px)]:p-4">
            <div className={`event-page-container flex flex-col gap-6 lg:gap-4 xl:gap-6 @[media(min-width:1024px)_and_(max-width:1366px)]:gap-4 ${darkMode ? 'dark-mode' : ''}`}>
              ...
              {/* Ongoing Class Section - Full width at top */}
              <section className={`event-ongoing-section rounded-xl shadow-sm p-5 lg:p-4 xl:p-5 w-full ${darkMode ? 'bg-[#111c44]' : 'bg-white'}`}>
                ...
                <div className="flex gap-4 lg:gap-3 xl:gap-4 overflow-x-auto no-scrollbar py-2">
                  <div className={`event-ongoing-card event-card-ui min-w-[260px] md:min-w-[300px] lg:min-w-[240px] xl:min-w-[300px] flex-shrink-0 ${darkMode ? 'bg-[#1b254b]' : 'bg-slate-50'}`}>
                  ...
                  <div className={`event-ongoing-card event-card-fullstack min-w-[260px] md:min-w-[300px] lg:min-w-[240px] xl:min-w-[300px] flex-shrink-0 ${darkMode ? 'bg-[#1b254b]' : 'bg-slate-50'}`}>
                    <div className="event-ongoing-header">
                  ...
                  <div className={`event-ongoing-card event-card-marketing min-w-[260px] md:min-w-[300px] lg:min-w-[240px] xl:min-w-[300px] flex-shrink-0 ${darkMode ? 'bg-[#1b254b]' : 'bg-slate-50'}`}>
                    <div className="event-ongoing-header">
                  ...
                  <div className={`event-ongoing-card event-card-app min-w-[260px] md:min-w-[300px] lg:min-w-[240px] xl:min-w-[300px] flex-shrink-0 ${darkMode ? 'bg-[#1b254b]' : 'bg-slate-50'}`}>
                    <div className="event-ongoing-header">
              ...
              {/* Two-column layout: Today Schedule (left 65%) | Calendar + Upcoming (right 35%) on desktop (xl) */}
              <div className="flex flex-col xl:flex-row gap-6 lg:gap-4 xl:gap-6">

                {/* Left Column: Today Schedule (65% on desktop) */}
                ...
                {/* Right Column: Calendar + Upcoming (35% on desktop) */}
                  ...
                  <section className={`event-upcoming-section rounded-xl shadow-sm p-5 lg:p-4 xl:p-5 flex flex-col gap-5 lg:gap-4 xl:gap-5 ${darkMode ? 'bg-[#141E5A] text-white' : 'bg-white'}`}>
                    ...
                    <div className="event-upcoming-list">
                      {upcomingItems.map((item) => (
                        <div key={item.id} className={`event-upcoming-item ${darkMode ? 'bg-[#1b254b]' : 'bg-slate-50'}`}>
