...
export function LearningActivity() {
  const [barCategoryGap, setBarCategoryGap] = useState("20%");
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md w-full max-w-full md:max-w-none p-5 min-w-0 min-h-[300px] flex flex-col">
      ...
      <div className="w-full h-[280px] sm:h-[300px] md:h-[320px] lg:h-[360px] min-h-[260px] px-2 md:px-6 py-4">
        <ResponsiveContainer width="100%" height="100%" aspect={undefined}>
          ...
          >
            ...
            <XAxis
              ...
              axisLine={false}
              tickLine={false}
              tick={{ fill: "#94A3B8", fontSize: xAxisFontSize, fontWeight: 600 }}
            />
            <YAxis
              axisLine={false}
              tickLine={false}
