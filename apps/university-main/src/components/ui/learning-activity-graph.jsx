...
export function LearningActivityGraph() {
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white px-4 md:px-5 pb-4 md:pb-5 pt-4 md:pt-5 shadow-sm w-full min-w-0 min-h-[300px] flex flex-col">
      ...
      <div className="w-full h-[280px] sm:h-[300px] md:h-[320px] lg:h-[360px] min-h-[260px]">
        {ready && (
          <ResponsiveContainer width="100%" height="100%" aspect={undefined} debounce={50}>
            <AreaChart
              data={data}
