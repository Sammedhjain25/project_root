...
export default function ProfileHeader() {
  return (
    <div className="bg-[#2B3674] rounded-card p-6 mb-6 min-h-[300px] soft-fade" style={{ boxShadow: "none" }}>
      <h2 className="text-[20px] font-poppins font-semibold text-white" style={{ marginBottom: '50px' }}>
        Student Details
      </h2>
        ...
        <div className="flex-1 soft-fade soft-fade-delay-1 w-full">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-sm font-poppins">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-medium font-poppins">{studentData.id}</span>
            </div>
            <div className="hidden md:block w-px h-4 bg-gray-400"></div>
            <div className="flex items-center gap-2">
              <span className="text-gray-300 font-poppins">Number:</span>
              <span className="text-white font-medium font-poppins">{studentData.number}</span>
            </div>
            <div className="hidden md:block w-px h-4 bg-gray-400"></div>
            <div className="flex items-center gap-2">
              <span className="text-gray-300 font-poppins">Email:</span>
              <span className="text-white font-medium font-poppins">{studentData.email}</span>
            </div>
            <div className="hidden md:block w-px h-4 bg-gray-400"></div>
            <div className="flex items-center gap-2">
              <span className="text-gray-300 font-poppins">Address:</span>
              <span className="text-white font-medium font-poppins">{studentData.address}</span>
            </div>
          </div>
        </div>
      </div>
