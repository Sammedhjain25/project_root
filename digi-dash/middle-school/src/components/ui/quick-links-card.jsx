...
export const NavCardWrapper = ({ children, className }) => (
  <div
    className={cn(
...
export const NavCardHeading = ({ children, className }) => (
  <h2 className={cn('text-3xl font-bold border-b-4 border-white/50 pb-2 mb-4', className)}>
    {children}
  </h2>
)

export const NavCardLink = ({ href, children, className }) => (
  <Link to={href} className={cn('block text-xl font-semibold py-2 hover:bg-white/10 rounded-md px-2 transition-colors', className)}>
    {children}
  </Link>
)
