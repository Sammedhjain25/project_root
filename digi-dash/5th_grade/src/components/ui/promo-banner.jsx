...
export const PromoBanner = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center flex-1 min-w-0 pr-0 md:pr-4 text-center md:text-left">
        <h2 className="text-white text-xl md:text-2xl lg:text-3xl font-bold mb-2 leading-tight">
          Welcome back!
          <br />
          Let's make today awesome!
        </h2>
        <p className="text-[#E8F1FF] text-sm md:text-base leading-relaxed max-w-md mt-1 mx-auto md:mx-0">
      ...
      <div className="absolute left-3/4 -translate-x-1/2 bottom-0 z-20">
        <img
