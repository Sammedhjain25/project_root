...
export default function StatChip({ icon, value, label, totalClasses, percentage, className }) {
  ...
  return (
    <div
      className={`p-3 rounded-[16px] w-full transition-all duration-300 hover:scale-105 hover:-translate-y-1 cursor-pointer ${className ?? ''}`.trim()}
      style={{
    ...
    >
        ...
        <div className="flex flex-col">
          <div className="flex items-center mb-2">
            <span
              ...
              style={{
                backgroundColor: isDark ? '#06B6D4' : '#1678FF',
                boxShadow: isDark ? '2px 2px 4px rgba(0, 0, 0, 0.3)' : '2px 2px 4px rgb(153, 161, 175)',
                width: '1.25rem',
                height: '1.25rem'
              }}
            >
      ...
      <div
        ...
        style={{
          backgroundColor: isDark ? '#232730' : '#e5e7eb',
          boxShadow: isDark ? '2px 2px 4px rgba(0, 0, 0, 0.3)' : '2px 2px 4px rgb(153, 161, 175)',
          width: '100%',
          height: '0.375rem',
